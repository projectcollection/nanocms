...
<!>
...
</pre></div>`,3);const Bt={hash:"svelte-1uha8ag",code:"body {margin:0;background-color:var(--color-white);}#services_text.svelte-1uha8ag {color:var(--color-white);}#services_text.svelte-1uha8ag:hover {color:var(--color-black);}"};function Vt(e,t){ft(t,!1),xt(e,Bt),Ye();var r=At(),d=gt(r),b=l(d);n(b,"bg_color","var(--color-purple-dark)"),U(b,"color: var(--color-white); font-size: var(--text-xs)");var c=l(b);n(c,"right",!0),n(c,"content-min-width","40");var v=l(c),a=h(v,2);n(a,"justify_end",!0);var u=h(l(a),2);n(u,"rounded",!0),n(u,"bg_color","var(--color-white)"),n(u,"p0",!0);var s=l(u);n(s,"right",!0);var f=h(l(s),2);n(f,"size","xs"),n(f,"bg-color","var(--color-yellow)"),n(f,"font-size","var(--text-sm)"),i(s),i(u),i(a),i(c),i(b);var p=h(b,2);n(p,"purple",!0);var _=l(p);n(_,"content-min-width","70");var B=l(_),o=h(B,2);n(o,"justify_end",!0),se(o,4,()=>["Resident","Businesses","Discover","Departments","Work With Us"],ae,(V,ee)=>{var g=zt();n(g,"underline",!0),n(g,"animated",!0);var F=l(g,!0);i(g),X(()=>_t(F,ee)),Y(V,g)}),i(o),i(_),i(p),i(d);var E=h(d,2),m=h(E,2);n(m,"p1",!0),n(m,"bg-color","var(--color-white-off)");var I=h(l(m),2);se(I,4,()=>[0,0,0,0,0],ae,(V,ee)=>{var g=Ft();n(g,"rounded",!0),n(g,"hover",!0),n(g,"bg-color","var(--color-blue-light)");var F=l(g),j=l(F),te=l(j);U(te,"font-size: 3rem;");var We=l(te);i(te),i(j),h(j,2),i(F),i(g),X(()=>ce(We,"src",St)),Y(V,g)}),i(I),i(m);var k=h(m,2);n(k,"p1",!0),n(k,"bg-color","var(--color-yellow-pale)");var z=l(k);n(z,"justify-between",!0);var w=h(l(z),2);n(w,"bg-color","var(--color-white-off)");var S=l(w),T=l(S);U(T,"font-size: 3rem;");var R=l(T);i(T),M(2),i(S),i(w);var x=h(w,2);n(x,"bg-color","var(--color-purple)"),i(z),i(k);var y=h(k,2);n(y,"p1",!0),n(y,"bg-color","var(--color-white-off)");var Q=h(l(y),2);se(Q,4,()=>[0,0,0,0,0],ae,(V,ee)=>{var g=Ht();n(g,"p0",!0),n(g,"rounded",!0),n(g,"hover",!0),n(g,"bg-color","var(--color-blue-light)");var F=l(g);U(F,"max-inline-size: 15em;");var j=h(l(F),2);U(j,"padding-bottom: var(--s1);"),i(F),i(g),Y(V,g)}),i(Q),i(y);var L=h(y,2),ue=l(L),he=h(l(ue),2),D=h(l(he),9);n(D,"bold",!0),n(D,"underline",!0),n(D,"animated",!0),n(D,"color","blue"),n(D,"title","github.com/nanocms"),n(D,"href","https://github.com/projectcollection/nanocms/tree/main/uilib/src/lib/layouts"),M(),i(he),M(4),i(ue),i(L);var K=h(L,2),ve=l(K),pe=h(l(ve)),Ne=h(l(pe));q(Ne,()=>hljs.highlight('<bt-link underscore animated href="#">some link</bt-link>',{language:"html"}).value),M(),i(pe),M(),i(ve),i(K);var Le=h(K,2),Z=h(Le,2),fe=l(Z),ge=h(l(fe)),Ve=h(l(ge));q(Ve,()=>hljs.highlight(`<bt-link class="s-y_bCXRrkrYfP" data-i="bt-link-2oQcUI">
            #shadow-root (open)
            <a href="#" part="bt-link-2oQcUI">
                <slot></slot>
            </a>
            some link
        </bt-link>`,{language:"html"}).value),M(),i(ge),M(),i(fe),i(Z);var je=h(Z,2),$=h(je,2),me=l($),_e=h(l(me)),Ue=h(l(_e));q(Ue,()=>hljs.highlight(`<style id="bt-link-2oQcUI">
        ...
        </style>`,{language:"css"}).value),M(),i(_e),M(),i(me),i($);var Pe=h($,2),ke=h(Pe,2),ye=l(ke),we=h(l(ye)),Oe=h(l(we));q(Oe,()=>hljs.highlight(`<div style="position: sticky; top:0;">
        <bt-box
   ...
   `,{language:"html"}).value),M(),i(we),M(),i(ye),i(ke),X(()=>ce(R,"src",Mt)),Y(e,r),mt()}export{Vt as component};
